...
# Section-2: Exploring Sequence Data
def head(seq):
...
def seqInfo(seq):
    """Returns sequence summary: length, frequency, percentage, GC content, AT content"""
    L = len(seq)
...
# Section-3: Frequency and Percentage
...
# Nucleotide Density
# ==================
def __myscatterplot(xvar,ydict,xlab,ylab, title):
    """Makes a scatterplot of y-variable(s) against an x-variable"""
